...
export default function FinalCTA() {
  ...
  return (
    <section id="cta" className="relative z-10 overflow-hidden border-t border-white/55 px-4 py-20 sm:px-6 md:py-32 xl:py-36">
      ...
      <motion.div
        className="container relative mx-auto max-w-5xl rounded-[1.6rem] border border-white/80 bg-white/82 p-5 text-center shadow-[0_32px_90px_-42px_rgba(15,23,42,0.34)] backdrop-blur-2xl sm:rounded-[2.25rem] sm:p-10 md:p-14 xl:max-w-[90rem] xl:p-12 2xl:max-w-[96rem] 2xl:p-14"
          ...
          <div className="mt-7 rounded-[1.25rem] border border-white/80 bg-white/70 p-4 shadow-sm sm:mt-8 sm:p-5 xl:mt-0 xl:rounded-[1.6rem] xl:p-6">
            <div className="flex flex-col items-center gap-3 sm:gap-4 sm:flex-row sm:justify-center xl:flex-col xl:items-stretch xl:justify-start">
              ...
              <Link href="/certificazioni" className="focus-ring w-full rounded-full">
                <Button variant="outline" size="lg" className="h-[52px] w-full rounded-full border-white/70 bg-white/80 px-6 text-[15px] font-semibold shadow-sm backdrop-blur-xl hover:bg-white/90 sm:h-14 sm:px-8 sm:text-base">
                  Esplora Catalogo
                </Button>
              </Link>
            </div>
